    ...
    return(
        <header className="bg-white flex justify-between align-center px-28 py-4 w-[100%]">
            ...
            <nav className="flex items-center justify-center gap-10">
                <button className="hover:scale-105 transition-all" onClick={() => router.push("/dashboard")}>Inicio</button>
                <button className="hover:scale-105 transition-all" onClick={() => router.push("/tickets/history")} href="">Historial de tickets</button>
